...
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/exu_type
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/has_rd
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/has_rs1
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/has_rs2
add wave -noupdate -group scoreboard -radix unsigned /mp4_tb/dut/cpu/sb0/rd
add wave -noupdate -group scoreboard -radix unsigned /mp4_tb/dut/cpu/sb0/rs1
add wave -noupdate -group scoreboard -radix unsigned /mp4_tb/dut/cpu/sb0/rs2
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/ready
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/has_rd_wb
add wave -noupdate -group scoreboard -radix unsigned /mp4_tb/dut/cpu/sb0/rd_wb
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/can_issue
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/reg_states
add wave -noupdate -group scoreboard /mp4_tb/dut/cpu/sb0/exu_status
...
WaveRestoreCursors {{Cursor 1} {3430236 ps} 0} {{Cursor 2} {2134439508 ps} 0}
...
update
WaveRestoreZoom {3373887 ps} {3513149 ps}
