...
add wave -noupdate /mp4_tb/dut/inst_resp
...
add wave -noupdate -expand -group scoreboard /mp4_tb/dut/cpu/can_issue
...
add wave -noupdate -expand -group lsu_exec -expand -group agu -radix decimal /mp4_tb/dut/cpu/agu_rd_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu /mp4_tb/dut/cpu/agu_ctrl_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu -radix hexadecimal /mp4_tb/dut/cpu/agu_valu_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu -radix hexadecimal /mp4_tb/dut/cpu/agu_base_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu -radix hexadecimal /mp4_tb/dut/cpu/agu_ofst_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu -radix hexadecimal /mp4_tb/dut/cpu/agu_addr_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu /mp4_tb/dut/cpu/agu_mbe_ex
add wave -noupdate -expand -group lsu_exec -expand -group agu /mp4_tb/dut/cpu/agu_has_rd_ex
...
add wave -noupdate -expand -group lsu_exec -expand -group mem /mp4_tb/dut/cpu/data_read
add wave -noupdate -expand -group lsu_exec -expand -group mem /mp4_tb/dut/cpu/data_write
add wave -noupdate -expand -group lsu_exec -expand -group mem /mp4_tb/dut/cpu/data_resp
...
WaveRestoreCursors {{Cursor 1} {2329161 ps} 0} {{Cursor 2} {2134439508 ps} 0}
...
update
WaveRestoreZoom {2285893 ps} {2425155 ps}
