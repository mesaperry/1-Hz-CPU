...
add wave -noupdate -expand -group queue /mp4_tb/dut/cpu/aluq_sig
add wave -noupdate -expand -group queue /mp4_tb/dut/cpu/memq_sig
...
WaveRestoreCursors {{Cursor 1} {10615 ps} 0} {{Cursor 2} {2134439508 ps} 0}
